...
class PermissionsExamples : BaseActivity() {
    ...
    override fun initView() {
        ...
        data = SetDataAll.getOptionsAll(this, AppConstants.PERMISSION_EXAMPLS)
    ...
    private fun ShowActivity(value: String) {
        when (value) {
            AppConstants.FetchContacts -> {
                startActivity(Intent(this, FetchContacts::class.java))
            }
        }
    }
