...
import examplesAll.viewPagerExamples.horizontalViewPagerTrajilis.adapterAll.StudentsAdapter
import java.util.ArrayList
import java.util.HashMap

class StudentsNameFragment : Fragment(){
    var viewBinding: FragmentStudentNameBinding? = null
    var studentAdapter: StudentsAdapter? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        studentAdapter = StudentsAdapter(requireContext(), requireActivity(),
                R.layout.adapter_secondary_options, data!!)
