...
import androidx.fragment.app.Fragment;
    ...
    public final class CropImage {
        ...
        /** The key used to pass crop image source URI to {@link CropImageMainActivity}. */
        public static final String CROP_IMAGE_EXTRA_SOURCE = "CROP_IMAGE_EXTRA_SOURCE";

        /** The key used to pass crop image options to {@link CropImageMainActivity}. */
        public static final String CROP_IMAGE_EXTRA_OPTIONS = "CROP_IMAGE_EXTRA_OPTIONS";

        /** The key used to pass crop image bundle data to {@link CropImageMainActivity}. */
        public static final String CROP_IMAGE_EXTRA_BUNDLE = "CROP_IMAGE_EXTRA_BUNDLE";

        /** The key used to pass crop image result data back from {@link CropImageMainActivity}. */
        ...
        /**
         * The request code used to start {@link CropImageMainActivity} to be used on result to identify the
         * this specific request.
         */
        public static final int CROP_IMAGE_ACTIVITY_REQUEST_CODE = 203;

        /** The result code used to return error from {@link CropImageMainActivity}. */
         ...
         * CropImageMainActivity} to crop the selected image.<br>
        ...
        /**
         * Create {@link ActivityBuilder} instance to start {@link CropImageMainActivity} to crop the given
         * image.<br>
         * Result will be received in  and can be
         * retrieved using {@link #getActivityResult(Intent)}.
         *
        ...
        /**
         * Get {@link CropImageMainActivity} result data object for crop image activity started using {@link
         * #activity(Uri)}.
         *
        ...
        public static final class ActivityBuilder {
            ...
            /** Get {@link CropImageMainActivity} intent to start the activity. */
            public Intent getIntent(@NonNull Context context) {
                return getIntent(context, CropImageMainActivity.class);
            }
            ...
            /**
             * Start {@link CropImageMainActivity}.
             *
             ...
             */
            public ActivityBuilder setCropShape(@NonNull CropImageVieww.CropShape cropShape) {
             ...
             */
            public ActivityBuilder setGuidelines(@NonNull CropImageVieww.Guidelines guidelines) {
             ...
             */
            public ActivityBuilder setScaleType(@NonNull CropImageVieww.ScaleType scaleType) {
            ...
            /**
             * the title of the {@link CropImageMainActivity}.<br>
             * <i>Default: ""</i>
             */
             ...
             * Uses {@link CropImageVieww.RequestSizeOptions#RESIZE_INSIDE} option.<br>
             * <i>Default: 0, 0 - not set, will not resize</i>
             */
            public ActivityBuilder setRequestedSize(int reqWidth, int reqHeight) {
                return setRequestedSize(reqWidth, reqHeight, CropImageVieww.RequestSizeOptions.RESIZE_INSIDE);
            }
            ...
            public ActivityBuilder setRequestedSize(
                    int reqWidth, int reqHeight, CropImageVieww.RequestSizeOptions options) {
        ...
        public static final class ActivityResult extends CropImageVieww.CropResult implements Parcelable {
