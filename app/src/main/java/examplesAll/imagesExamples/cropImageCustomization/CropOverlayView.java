...
public class CropOverlayView extends View {
  ...
  private CropImageVieww.Guidelines mGuidelines;

  /** The shape of the cropping area - rectangle/circular. */
  private CropImageVieww.CropShape mCropShape;
  ...
  /** The shape of the cropping area - rectangle/circular. */
  public CropImageVieww.CropShape getCropShape() {
    return mCropShape;
  }

  /** The shape of the cropping area - rectangle/circular. */
  public void setCropShape(CropImageVieww.CropShape cropShape) {
    if (mCropShape != cropShape) {
      mCropShape = cropShape;
        if (Build.VERSION.SDK_INT <= 17) {
        if (mCropShape == CropImageVieww.CropShape.OVAL) {
  ...
  public CropImageVieww.Guidelines getGuidelines() {
    return mGuidelines;
  }
   ...
   * application.
   */
  public void setGuidelines(CropImageVieww.Guidelines guidelines) {
  ...
  protected void onDraw(Canvas canvas) {
    ...
    if (mCropWindowHandler.showGuidelines()) {
      ...
      if (mGuidelines == CropImageVieww.Guidelines.ON) {
        drawGuidelines(canvas);
      } else if (mGuidelines == CropImageVieww.Guidelines.ON_TOUCH && mMoveHandler != null) {
  ...
  private void drawBackground(Canvas canvas) {
    ...
    if (mCropShape == CropImageVieww.CropShape.RECTANGLE) {
      ...
      mPath.reset();
        if (Build.VERSION.SDK_INT <= 17 && mCropShape == CropImageVieww.CropShape.OVAL) {
  ...
  private void drawCorners(Canvas canvas) {
    if (mBorderCornerPaint != null) {
      ...
      float w =
          cornerWidth / 2
              + (mCropShape == CropImageVieww.CropShape.RECTANGLE ? mBorderCornerOffset : 0);
