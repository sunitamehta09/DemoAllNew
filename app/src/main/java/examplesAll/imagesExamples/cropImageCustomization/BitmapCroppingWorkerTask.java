...
final class BitmapCroppingWorkerTask
  ...
  private final WeakReference<CropImageVieww> mCropImageViewReference;
  ...
  private final CropImageVieww.RequestSizeOptions mReqSizeOptions;
  ...
  BitmapCroppingWorkerTask(
          ...
          CropImageVieww.RequestSizeOptions options,
          Uri saveUri,
  ...
  protected void onPostExecute(Result result) {
    if (result != null) {
      ...
      if (!isCancelled()) {
        CropImageVieww cropImageView = mCropImageViewReference.get();
