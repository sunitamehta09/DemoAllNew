...
public class CropImageOptions implements Parcelable {
  ...
  public CropImageVieww.CropShape cropShape;
  ...
  public CropImageVieww.Guidelines guidelines;

  /** The initial scale type of the image in the crop image view */
  public CropImageVieww.ScaleType scaleType;
  ...
  public CropImageVieww.RequestSizeOptions outputRequestSizeOptions;
  ...
  public CropImageOptions() {
    ...
    cropShape = CropImageVieww.CropShape.RECTANGLE;
    ...
    guidelines = CropImageVieww.Guidelines.ON_TOUCH;
    scaleType = CropImageVieww.ScaleType.FIT_CENTER;
    ...
    outputRequestSizeOptions = CropImageVieww.RequestSizeOptions.NONE;
    noOutputImage = false;
  ...
  protected CropImageOptions(Parcel in) {
    cropShape = CropImageVieww.CropShape.values()[in.readInt()];
    snapRadius = in.readFloat();
    touchRadius = in.readFloat();
    guidelines = CropImageVieww.Guidelines.values()[in.readInt()];
    scaleType = CropImageVieww.ScaleType.values()[in.readInt()];
    ...
    outputRequestSizeOptions = CropImageVieww.RequestSizeOptions.values()[in.readInt()];
