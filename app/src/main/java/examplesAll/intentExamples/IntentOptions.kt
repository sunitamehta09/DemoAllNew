...
class IntentOptions : BaseActivity(), TextWatcher {
    ...
    override fun initView() {
        ...
        data = SetDataAll.getOptionsAll(this, AppConstants.INTENT_EXAMPLS)

        centralizeOptionsAdapter = CentralizeOptionsAdapter(this@IntentOptions, AppConstants.showSecondaryOptions,
        ...
        viewBinding.recyclerView.layoutManager = GridLayoutManager(this@IntentOptions, 3)
    ...
    private fun startNewActivity(activityType: String) {
        val intent: Intent
        when (activityType) {
            AppConstants.StartActivityForResult -> {
                intent = Intent(this, StartActivityForResult::class.java)
                startActivity(intent)
            }

            AppConstants.ImplicitIntentExamples -> {
                intent = Intent(this, ImplicitIntentOptions::class.java)
                startActivity(intent)
            }
        }
    }
