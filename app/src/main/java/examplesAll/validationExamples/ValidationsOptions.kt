...
class ValidationsOptions : BaseActivity() {
    ...
    override fun initView() {
        ...
        data = SetDataAll.getOptionsAll(this, AppConstants.VALIDATIONS_EXAMPLS)
    ...
    private fun ShowActivity(value: String) {
        when (value) {
            AppConstants.LoginFormValidations -> {
                startActivity(Intent(this, LoginFormValidations::class.java))
            }
            AppConstants.PasswordValidations -> {
